    ...
    return (
        <div className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(249,115,22,0.18),_transparent_25%),radial-gradient(circle_at_80%_20%,_rgba(14,165,233,0.20),_transparent_20%),linear-gradient(180deg,_#fff8ef_0%,_#fffdf8_34%,_#f4fbff_100%)] text-slate-900 dark:bg-[radial-gradient(circle_at_top_left,_rgba(251,146,60,0.20),_transparent_22%),radial-gradient(circle_at_80%_20%,_rgba(56,189,248,0.18),_transparent_22%),linear-gradient(180deg,_#0f172a_0%,_#111827_42%,_#020617_100%)] dark:text-white">
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <header className="motion-fade-up flex flex-col gap-4 rounded-[2rem] border border-white/70 bg-white/70 px-4 py-4 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur sm:flex-row sm:items-center sm:justify-between sm:rounded-full sm:px-5 sm:py-3 dark:border-white/10 dark:bg-slate-900/55 dark:shadow-none">
                    <div className="min-w-0">
                        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-orange-500">
                            AI Career Guidance
                        </p>
                        <p className="font-display text-base font-semibold sm:text-lg">Plan your next career move with clarity.</p>
                    </div>

                    <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
                        <Link
                            to="/login"
                            className="rounded-full border border-slate-200 bg-white px-4 py-2 text-center text-sm font-semibold text-slate-700 transition hover:border-orange-300 hover:text-orange-500 dark:border-white/10 dark:bg-slate-900 dark:text-white"
                        >
                            Login
                        </Link>
                        <Link
                            to="/signup"
                            className="rounded-full bg-slate-900 px-5 py-2 text-center text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-orange-400 dark:text-slate-950 dark:hover:bg-orange-300"
                        >
                            Sign up
                        </Link>
                    </div>
                ...
                <section className="grid gap-10 pt-10 sm:pt-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                    <div>
                        ...
                        <h1 className="mt-6 max-w-4xl font-display text-4xl font-semibold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            <Link
                                to="/signup"
                                className="motion-button motion-glow inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-500/30 transition hover:translate-y-[-1px]"
                            >
                                Start for free
                            ...
                            <Link
                                to="/login"
                                className="motion-button inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-orange-300 hover:text-orange-500 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                            >
                                Open workspace
                            </Link>
                        </div>
                        ...
                        <div className="mt-10 grid gap-3 sm:grid-cols-2">
                            {highlights.map((item) => (
                                <div
                                    key={item}
                                    className="motion-card flex items-center gap-3 rounded-2xl border border-white/70 bg-white/70 px-4 py-3 text-sm text-slate-700 backdrop-blur dark:border-white/10 dark:bg-slate-900/50 dark:text-slate-200"
                                >
                    ...
                    <div className="relative">
                        <div className="absolute inset-0 translate-x-3 translate-y-3 rounded-[2.5rem] bg-gradient-to-br from-orange-200 to-sky-200 opacity-70 blur-3xl sm:translate-x-6 sm:translate-y-6 dark:from-orange-500/20 dark:to-sky-500/20" />
                        <div className="motion-card motion-fade-up-delay-1 relative overflow-hidden rounded-[2.5rem] border border-white/70 bg-white/75 p-6 shadow-[0_32px_90px_rgba(15,23,42,0.12)] backdrop-blur dark:border-white/10 dark:bg-slate-900/60 dark:shadow-[0_32px_90px_rgba(2,6,23,0.45)]">
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div className="w-fit rounded-2xl bg-slate-900 px-3 py-2 text-sm font-semibold text-white dark:bg-orange-400 dark:text-slate-950">
                                    92% focus
                                </div>
                            </div>

                            <div className="mt-6 grid gap-4 sm:grid-cols-2">
                                <div className="motion-card rounded-[1.75rem] bg-slate-900 p-5 text-white dark:bg-slate-950">
                                ...
                                <div className="motion-card rounded-[1.75rem] border border-slate-200 bg-slate-50 p-5 dark:border-white/10 dark:bg-slate-950/50">
                                ...
                                <div className="motion-card rounded-[1.75rem] border border-slate-200 bg-white p-5 dark:border-white/10 dark:bg-slate-950/50">
                ...
                <section className="mt-20">
                    ...
                    <div className="mt-10 grid gap-6 lg:grid-cols-3">
                        {features.map(({ title, description, icon }) => (
                            <article
                                key={title}
                                className="motion-card motion-fade-up rounded-[2rem] border border-white/70 bg-white/70 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur dark:border-white/10 dark:bg-slate-900/55 dark:shadow-none"
                            >
                                <IconBubble
                                    icon={
                                        icon === "AI"
                ...
                <section className="motion-card motion-fade-up mt-20 rounded-[2.5rem] border border-slate-200/70 bg-slate-900 px-6 py-10 text-white shadow-[0_30px_90px_rgba(15,23,42,0.18)] sm:px-10 dark:border-white/10">
